...
/// - couldNotConnectToService: Could not connect to the NISwiftVISAService user agent on the computer.
...
/// - instrumentDeallocated: The instrument has been deallocated and is no longer available.
public enum NIError: Error {
